...
export class Client implements IClient {
     ...
     */
    userStatistics(period: string | undefined): Observable<ObjectResult> {
        let url_ = this.baseUrl + "/api/Users/user-statistics?";
        if (period === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUserStatistics(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUserStatistics(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ObjectResult>;
                }
            } else
    ...
    protected processUserStatistics(response: HttpResponseBase): Observable<ObjectResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
